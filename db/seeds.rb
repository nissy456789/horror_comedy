...
movie.images.attach([
  {
    io: URI.open('https://abchorror.s3.ap-northeast-1.amazonaws.com/willyswonderland.jpg'),
...
movie.images.attach([
  {
    io: URI.open('https://abchorror.s3.ap-northeast-1.amazonaws.com/londonzombiposter.jpg'),
...
movie.images.attach([
  {
    io: URI.open('https://abchorror.s3.ap-northeast-1.amazonaws.com/kiryuunomura.jpg'),
