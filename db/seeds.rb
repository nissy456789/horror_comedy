...
Movie.create(
  ...
  avatar: 'https://abchorror.s3.ap-northeast-1.amazonaws.com/willyswonderland.jpg' # S3のURLを直接指定
)
...
Movie.create(
  ...
  avatar: 'https://abchorror.s3.ap-northeast-1.amazonaws.com/londonzombiposter.jpg' # S3のURLを直接指定
)

Movie.create(
  title: '黄龍の村',
  description: 'これ、村の決まりやから。キャンプ場への道中携帯も繋がらない山中で車がパンクし助けを求めて迷い歩く若者達がたどり着いた「切龍村」その近妙な村を舞台に狂気の集団と若者たちの想像を絶する惨劇が勃発するスリラーホラー',
  avatar: 'https://abchorror.s3.ap-northeast-1.amazonaws.com/kiryuunomura.jpg' # S3のURLを直接指定
)

puts 'Seed data has been created and images reference S3.'